export const caseStudyTechnologiesData = [
  // Pixel Valley Supply (caseStudyId is automatically assigned by the database, not the projectId)
  { name: "Django", caseStudyId: 1 },
  { name: "React", caseStudyId: 1 },
  { name: "TypeScript", caseStudyId: 1 },
  { name: "PostgreSQL", caseStudyId: 1 },
  ...
  { name: "Vite", caseStudyId: 2 },
  { name: "Django", caseStudyId: 2 },
  ...
  { name: "Pinecone", caseStudyId: 3 },
  { name: "React", caseStudyId: 3 },
  { name: "TypeScript", caseStudyId: 3 },
  ...
  { name: "TypeScript", caseStudyId: 5 },
  { name: "PostgreSQL", caseStudyId: 5 },
